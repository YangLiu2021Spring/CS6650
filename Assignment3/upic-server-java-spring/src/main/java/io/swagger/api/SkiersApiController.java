...
public class SkiersApiController implements SkiersApi {
    ...
    public ResponseEntity writeNewLiftRide(
        ...
        try {
            skierMessageQueueManager.publish(toJson(liftRide,resortID, seasonID,dayID,skierID));
        } catch (RuntimeException e) {
            log.error("Failed to publish message {}", toJson(liftRide,resortID, seasonID,dayID,skierID), e);
            throw e;
        }
    ...
    private String toJson(LiftRide liftRide, int resortID, String seasonID, String dayID, int skierID) {
        return String.format("{" +
                        ...
                        "\"skierID\":%d " +
                        "}",
                liftRide.getLiftID().intValue(),
                liftRide.getTime().intValue(),
                resortID,
                seasonID,
                dayID,
                skierID
